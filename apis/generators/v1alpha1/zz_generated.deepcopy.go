...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FederationAuth) DeepCopyInto(out *FederationAuth) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FederationAuth.
func (in *FederationAuth) DeepCopy() *FederationAuth {
	if in == nil {
		return nil
	}
	out := new(FederationAuth)
	in.DeepCopyInto(out)
	return out
}
