...
// ManagerInterface defines the interface for a secrets manager
...
type ManagerInterface interface {
	...
	GetFromStore(ctx context.Context, store esv1.GenericStore, namespace string) (esv1.SecretsClient, error)
