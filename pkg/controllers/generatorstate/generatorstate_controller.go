...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, err error) {
	...
	if generatorState.Spec.GarbageCollectionDeadline != nil {
		...
		if err != nil {
			r.markAsFailed(genv1alpha1.GeneratorStatePendingDeletion, genv1alpha1.ConditionReasonError, "Could not get generator cleanup policy", err, generatorState)
		...
		if cleanupPolicy != nil && cleanupPolicy.Type == genv1alpha1.IdleCleanupPolicy {
			...
			if err != nil {
				r.markAsFailed(genv1alpha1.GeneratorStatePendingDeletion, genv1alpha1.ConditionReasonError, "Could not check idle timeout", err, generatorState)
