...
// Provider implements the WorkflowRunTemplate handler provider.
type Provider struct{}

// NewHandler creates a new WorkflowRunTemplate handler.
...
func init() {
	schema.RegisterProvider(schema.Workflow, &Provider{})
}
