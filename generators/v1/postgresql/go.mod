module github.com/external-secrets/external-secrets/generators/v1/postgresql
...
replace github.com/external-secrets/external-secrets/generators/v1/password => ../../../generators/v1/password